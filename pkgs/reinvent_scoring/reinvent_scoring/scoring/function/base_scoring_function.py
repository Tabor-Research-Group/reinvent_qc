...
class BaseScoringFunction(ABC):
    ...
    def _component_is_penalty(self, summary: ComponentSummary) -> bool:
        return (summary.parameters.component_type == self.component_enum.MATCHING_SUBSTRUCTURE) or (
                ...
                summary.parameters.component_type == self.component_enum.SCSCORE) or (
                summary.parameters.component_type == self.component_enum.MOLECULAR_WEIGHT) or (
                summary.parameters.component_type == self.component_enum.CONS_ROTATABLE_BONDS)
